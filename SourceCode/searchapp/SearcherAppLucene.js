...
async function integrateResults(sources, webIdQuery, searchWord,topKPodDocs) {
...
function logResultsToFile(webid, query, results) {
    const filePath = path.join(__dirname, 'results-top-7-servers.txt');
...
app.get("/query", async (req, res) => {
    ...
    try {
        ...
        //relevantServers=["srv03812.soton.ac.uk:3000","srv03813.soton.ac.uk:3000","srv03814.soton.ac.uk:3000","srv03815.soton.ac.uk:3000","srv03816.soton.ac.uk:3000"];
                    ...
                    serverLimit(async () => {
                        try {
                            ...
                            if (relevantPods.length > 0) {
                                ...
                                const integratedResult = await integrateResults(relevantPods, webId, searchWord,topKPodDocs);
        ...
        logResultsToFile(webId,searchWord,finalResult);
