...
//public String extractSparqlQueryFromWhereClause(String sql) {
//    String sparqlQuery = "";
//
//    // Pattern to find the SPARQL query within the WHERE clause, regardless of the field name
//    String patternString = "WHERE\\s+\\w+='--\\s*SPARQL\\s+Query:(.*?)'";
//    Pattern pattern = Pattern.compile(patternString, Pattern.DOTALL | Pattern.CASE_INSENSITIVE);
//
//    // Match the pattern in the SQL query
//    Matcher matcher = pattern.matcher(sql);
//    if (matcher.find()) {
//        // Extract the SPARQL query, trim it, and remove the enclosing '-- SPARQL Query:' prefix
//        sparqlQuery = matcher.group(1).trim();
//    }
//
//    System.out.println("::::: Extracted SPARQL Query :::::\n" + sparqlQuery);
//    return sparqlQuery;
//}
